...
#define wc0(DATA) SPI_Master_transmit_char(DATA, true,1)
#define wd0(DATA) SPI_Master_transmit_char(DATA, false,1)

//#define wc(DATA) SPI_Master_transmit_char_fast(DATA)
//#define wd(DATA) SPI_Master_transmit_char_fast(DATA)

#define wc(DATA) SPI_Master_transmit_char(DATA, true, 1)
#define wd(DATA) SPI_Master_transmit_char(DATA, false, 1)
...
void SPI_Master_transmit_char(uint8_t data, bool commandmode,  uint8_t slave);
